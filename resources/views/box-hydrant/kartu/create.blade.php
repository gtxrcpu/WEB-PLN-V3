{{-- resources/views/box-hydrant/kartu/create.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="utf-8">
    <title>Kartu Kendali Box Hydrant</title>
...
<div class="no-print bg-gradient-to-r from-blue-600 to-cyan-600 shadow-lg mb-6">
    <div class="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <div class="text-xs text-red-100 font-medium">Kartu Kendali Box Hydrant</div>
                <div class="text-xl font-bold text-white">
                    {{ $boxHydrant->barcode ?? $boxHydrant->serial_no ?? 'Box Hydrant' }}
                </div>
            </div>
        </div>
        <div class="flex items-center gap-3">
            ...
            <button onclick="window.print()"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white text-blue-600 text-sm font-semibold hover:bg-red-50 transition-all duration-200 shadow-lg">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="sheet-a4 bg-white mx-auto rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
        ...
        <div class="border border-slate-400">
            <div class="px-4 py-2 border-b border-slate-400 text-center">
                ...
                <div class="text-sm font-semibold">PILAR HYDRANT</div>
